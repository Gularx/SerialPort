...
int main(int argc,char *argv[]) {
    ...
    serial_port.COM = new char[10];
    serial_port.str = new char[50];
...
/****************************************************************************/
    ...
    str_year_input->setFixedSize(40, 30);
    ...
    str_month_input->setFixedSize(40, 30);
    ...
    str_day_input->setFixedSize(40, 30);
...
/****************************************************************************/
    ...
    str_hour_input->setFixedSize(40, 30);
    ...
    str_min_input->setFixedSize(40, 30);
    ...
    str_sec_input->setFixedSize(40, 30);
...
/****************************************************************************/
    ...
    QObject::connect(button_send, &QPushButton::clicked, window, [=]{
        COM_input->text()      = serial_port.COM;
        baudrate_input->text() = (char)serial_port.baudrate;
        parity_input->text()   = serial_port.parity;
        databit_input->text()  = serial_port.databit;
        stopbit_input->text()  = serial_port.stopbit;
